...
// GetDiskStatus inspects the filesystem hosting path using both
// absolute-free-space and percentage thresholds.
...
// GetDiskStatusFull is the full form with absolute-free-space floors.
